module NotificationPlugin::NotificationManager
  ...
  def new
    @notification = NotificationPlugin::Notification.new
    if request.post?
      @notification = NotificationPlugin::Notification.new(params[:notifications])
