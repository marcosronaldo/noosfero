class NotificationPluginPublicController < PublicController

  helper NotificationPlugin::NotificationHelper
  include NotificationPlugin::NotificationHelper
  ...
  def close_notification
    ...
    if logged_in?
      @notification = NotificationPlugin::Notification.find_by_id(params[:notification_id])
